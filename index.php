...
# Default
$_OPTIMIZATION = array();
$_OPTIMIZATION["title"] = "GOLDEBIRDS";
$_OPTIMIZATION["description"] = "GOLDENBIRDS";
...
@include("inc/_header.php");
		...
		if(isset($_GET["menu"])){
			...
			switch($menu){
                ...
                case "video": include("pages/_video.php"); break; // video
				...
				case "otziv": include("pages/_otziv.php"); break; // Отзыв
