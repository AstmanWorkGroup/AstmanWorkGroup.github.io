...
<center><h2>Аукцион ставок</h2></center>
<br>
...
<b><font size="+1" color="red">Лидер аукциона <font style="color:red;"><?=$lidermen["user"];?></font></b></font>
<br>
<b>
Стал лидером в <font style="color:black;"><?=date("d-m-y H:i:s" , $lidermen["date"]);?></font>

<br>


До завершения: - <span style="color:black;"><?=$ost;?></span>

<br>
Может выиграть <font style="color:black;"><?=$dengi*0.85;?></font>
<br>
Сделал ставку в <font style="color:black;"><?=$lidermen["among"];?></font>
</b>
</td>
</tr>
<br />
...
<tr bgcolor="#afeeee">
  ...
  <tr>
	...
	<input type="submit" class="btn_in" value="Поставить"  size="10"/></td>
  </tr>
</table>
</form>
</center>
