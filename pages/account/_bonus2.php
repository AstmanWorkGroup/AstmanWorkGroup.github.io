...
?>
<div class="s-bk-lf">
	<div class="acc-title">Бонус с риском</div>
</div>
<div class="silver-bk">
<div class="clr"></div>
...
Бонус выдается Эко$ на счет для покупок. <BR />
Сумма бонуса генерируется случайно от <b><?=$bonus_min;?></b> до <b><?=$bonus_max;?></b> Эко$.
<BR /><BR />
<?PHP
$ddel = time() + 60*60*96;
$dadd = time();
