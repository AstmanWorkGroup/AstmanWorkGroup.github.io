...
<center>Всего имеется <?=$num_bil; ?> билетов. После того, как все билеты будут проданы, состоится розыгрыш счастливых билетов. Система случайным образом выберет 3 номера счастливых билетов и зачислит им призы на баланс На (ВЫВОД). <BR />
<br>1 место - 50% от общего банка [<?=($amount_lottery * $num_bil) * 0.5; ?> серебра]. <BR />
...
<br>Остальные 5% составляют комиссию системы.
<BR />
<br><u>Стоимость билета = <?=$amount_lottery; ?> серебра</u>.
<BR />
