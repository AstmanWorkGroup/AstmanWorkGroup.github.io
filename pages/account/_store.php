...
<div class="silver-bk">»з ваших гнезд €йца попадают на склад, собирайте их и продавайте. ¬ы можете делать это раз в 10 мин. яйца посто€нно накапливаютс€ и хран€тс€ в холодильнике, вы можете собирать их даже раз в мес€ц, как вам удобнее.
<BR />
<BR />
<?PHP
...
<div class="clr"></div>	
<div class="sm-line">
<img src="/img/fruit/lime-small.jpg" />¬аших <?=$user_data["a_t"]; ?> птиц снесли: <font color="#000"> <?=$func->SumCalc($sonfig_site["a_in_h"], $user_data["a_t"], $user_data["last_sbor"]);?> €иц</font></div>
<div class="sm-line">
<img src="/img/fruit/cherry-small.jpg" />¬аших <?=$user_data["b_t"]; ?> птиц снесли: <font color="#000"> <?=$func->SumCalc($sonfig_site["b_in_h"], $user_data["b_t"], $user_data["last_sbor"]);?> €иц</font></div>
<div class="sm-line"><img src="/img/fruit/kiwi-small.jpg" />¬аших <?=$user_data["c_t"]; ?> птиц снесли: <font color="#000"> <?=$func->SumCalc($sonfig_site["c_in_h"], $user_data["c_t"], $user_data["last_sbor"]);?> €иц</font></div>
<div class="sm-line"><img src="/img/fruit/strawberries-small.jpg" />¬аших <?=$user_data["d_t"]; ?> птиц снесли: <font color="#000"> <?=$func->SumCalc($sonfig_site["d_in_h"], $user_data["d_t"], $user_data["last_sbor"]);?> €иц</font></div>
<div class="sm-line"><img src="/img/fruit/orange-small.jpg" />¬аших <?=$user_data["e_t"]; ?> птиц снесли: <font color="#000"> <?=$func->SumCalc($sonfig_site["e_in_h"], $user_data["e_t"], $user_data["last_sbor"]);?> €иц</font></div>
<div class="clr"></div>
