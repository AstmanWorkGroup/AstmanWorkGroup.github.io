...
<div class="silver-bk"><div class="clr"></div>Теперь здесь можно оставить свой отзыв о нашем проекте! Что бы оставить отзыв сумма пополнений на вашем балансе должна быть 51 рублей или более. Бонусом за любой отзыв является случайное <b>вознаграждение от 100 до 500 серебро</b> для покупок. Если в отзыве есть скриншот выплаты начисляется <b>вознаграждение от 500 до 1000 кредитов</b> для покупок. Максимум можно оставить только 1 отзыв.<hr>
<font color="black">
...
} elseif ($user_insert < 51 or $col >= 1){
echo('<tr><td align="center" colspan="6"><font color="red"><center>Вы уже оставляли отзыв, либо Вы ещё не пополнили свой счет.(минимум 51 рублей)</center></font></td></tr>');
} else {
...
?>
	...
	Скрин выплаты URL картины: <input type="text" name="img" value="">(не обязательно)<br>
