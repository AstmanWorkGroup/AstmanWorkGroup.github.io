...
if(isset($_GET["sel"])){
	...
	switch($smenu){
		...
		case "chat": include("pages/admin/_chat.php"); break; // Чат
		case "bes": include("pages/admin/_bes.php"); break; // Личный кабинет
		case "otv": include("pages/admin/_otv.php"); break; // Ответит на тех. поддержку
		case "tik": include("pages/admin/_tik.php"); break; // Тех. поддержка
		...
		case "payments2": include("pages/admin/_payments2.php"); break; // выплаты2
		case "sender": include("pages/admin/_sender.php"); break; // Рассылка пользователям	
		case "pay_systems": include("pages/admin/_pay_systems.php"); break; // Платежные ситсемы
